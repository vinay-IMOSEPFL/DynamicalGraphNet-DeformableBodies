...
Three systems are included. The n-body case is the cleanest demonstration and is documented
...
three differ in how exactly they reproduce, which matters if you intend to compare numbers.
...
│
├── case_02_protein/
│   ├── mdanalysis/             # built by preprocess_data.py, not shipped
│   ├── preprocess_data.py      # run before training this case
│   ├── config.py
│   ├── dataset.py
│   └── visualization.py
│
